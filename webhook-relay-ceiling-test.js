...
export const options = {
  scenarios: {
    find_ceiling: {
      ...
      startRate: 1000,
      timeUnit: '1s',
      preAllocatedVUs: 200,   // VUs k6 pre-spins so ramping isn't itself a bottleneck
      maxVUs: 2000,           // hard ceiling on VUs k6 will spin up to sustain the rate
      stages: [
        { target: 1000, duration: '30s' },  // confirm baseline
